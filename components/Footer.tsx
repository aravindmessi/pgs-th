...
import { TwitterIcon, InstagramIcon, LinkedInIcon, DribbbleIcon, MailIcon, PhoneIcon, LogoIcon, LocationIcon } from './Icons';
                        ...
                        <ul className="space-y-4">
                            <li className="flex items-start">
                                ...
                                <address className="not-italic text-sm text-gray-400 text-left">
                                    F3,1/113, Jmj Complex, TNAU Nagar, Othakadai, Madurai - 625107, TN.
                                </address>
                            </li>
                ...
                <div className="flex flex-col sm:flex-row justify-between items-center text-center text-gray-500 text-sm border-t border-gray-800/50 pt-6 mt-10">
                    ...
                    <div className="flex space-x-4 order-1 sm:order-2">
                        {socialLinks.map(link => {
                            ...
                            return (
                                <a key={link.name} href={link.href} aria-label={link.name} className="text-gray-400 hover:text-purple-400 transition-colors">
