...
import mak from "./assets/madurai_kadai.webp";
...
import dbc from "./assets/dreamz_logo.webp"; // ✅ fixed path

// ✅ Client logo array (in import order)
const clientLogos = [
  bfm, cp, mb, ifi, vsm, avt,
  bga, mak, ars, nps, kok, kia,
...
const Home: React.FC = () => {
  ...
  console.log("Client Logos Array:", clientLogos);
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          <M.div initial="hidden" animate="visible">
            ...
            >
              ...
              solutions tailored to elevate your brand online presence and drive
              business growth.
            </M.p>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-6 md:gap-8">
            {clientLogos.map((logo, index) => (
              <div
                key={index}
                className="group bg-gray-900/40 flex justify-center items-center h-28 sm:h-32 p-6 rounded-xl border border-gray-800 backdrop-blur-sm transition-all duration-300 hover:-translate-y-2 hover:border-purple-500/50 hover:shadow-2xl hover:shadow-purple-900/20"
              >
                <img
                  src={logo}
                  alt={`Client Logo ${index + 1}`}
                  className="h-12 md:h-14 w-auto object-contain transition-all duration-300 filter grayscale opacity-70 group-hover:grayscale-0 group-hover:opacity-100"
                />
              </div>
            ))}
          </div>
